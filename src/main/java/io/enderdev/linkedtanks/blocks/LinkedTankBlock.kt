...
class LinkedTankBlock : BaseMachineBlock(LinkedTanks, "linked_tank", LinkedTanks.guiHandler.registerId(TileLinkedTank::class.java, ContainerLinkedTank::class.java) { GuiLinkedTank::class.java }) {
