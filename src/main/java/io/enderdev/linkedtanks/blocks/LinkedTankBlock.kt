...
class LinkedTankBlock : BaseMachineBlock(LinkedTanks, "linked_tank", TileLinkedTank::class.java, LinkedTanks.guiHandler.registerId(TileLinkedTank::class.java, ContainerLinkedTank::class.java) { GuiLinkedTank::class.java }) {
